...
export default function TrainingPage() {
  return (
    <main className="bg-navy-900 text-white min-h-screen">
      ...
      <section className="relative pt-32 pb-20 lg:pt-48 lg:pb-32 min-h-[90vh] flex items-center overflow-hidden">
        ...
        <div className="max-w-[1440px] mx-auto px-6 lg:px-12 relative z-10 grid lg:grid-cols-12 gap-12 items-center w-full">
          <div className="lg:col-span-7">
            ...
            <h1
              className="text-5xl lg:text-7xl font-bold leading-[1.1] mb-6 text-white"
            ...
            <div className="flex flex-wrap items-center gap-4">
              ...
              <a
                href="/about"
                className="inline-flex items-center gap-2 px-8 py-4 glass-panel hover:bg-navy-800 text-white font-semibold tracking-wide transition-all rounded-sm border border-gold-500/20"
              >
                Partner With APRN
              </a>
            </div>
          ...
          <div className="lg:col-span-5 hidden lg:block">
            <div className="relative w-full max-w-md mx-auto">
              ...
              <div className="glass-panel rounded-sm p-6 relative z-10 border border-navy-700 hover:border-gold-500/30 transition-colors">
            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-5">
                {[
                  {
                    value: "40%",
                    label: "Projected deficit in skilled pipeline engineers by 2030",
                  },
                  {
                    value: "$50B+",
                    label: "Planned infrastructure investments requiring local expertise",
                  },
                  {
                    value: "72%",
                    label: "Senior roles currently filled by non-African talent",
                  },
                  {
                    value: "12",
                    label: "AU member states with no domestically certified standards body",
                  },
                ].map((s) => (
                  <div
                    key={s.value}
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {tracks.map((t) => (
              ...
              >
                ...
                <h3 className="text-lg font-bold mb-3 text-white">{t.title}</h3>
      ...
      <section className="py-24 bg-navy-900 border-t border-navy-800 relative overflow-hidden">
        <div
          ...
          style={{
            backgroundImage:
              "radial-gradient(ellipse at 50% 80%, rgba(212,160,23,0.08) 0%, transparent 60%)",
          }}
        />
        <div className="max-w-4xl mx-auto px-6 relative z-10 text-center">
          ...
          <div className="flex flex-wrap justify-center items-center gap-4">
            ...
            <a
              href="/about"
              className="inline-block px-8 py-4 glass-panel hover:bg-navy-800 text-white font-semibold tracking-wide transition-all rounded-sm border border-gold-500/20"
            >
              Partner With APRN
            </a>
          </div>
