...
const STAKEHOLDERS: Stakeholder[] = [
  ...
  { id: "joseph",  name: "Joseph Agwuh",         org: "APRN Africa",         type: "Internal",     influence: "High", interest: "High", relationship: "Core Team", engagementStrategy: "Daily collaboration; owns tech, engineering, and comms delivery.", lastContact: "Today",    ix: 9, iy: 9 },
  { id: "allison", name: "Allison Gabriel",      org: "APRN Africa",         type: "Internal",     influence: "Med",  interest: "High", relationship: "Ambassador", engagementStrategy: "Weekly WhatsApp + email on programs and events.",              lastContact: "This week", ix: 8, iy: 5 },
  ...
  { id: "tokun",   name: "Tokunbo Khadijat",     org: "APRN Africa",         type: "Internal",     influence: "Med",  interest: "High", relationship: "Content Manager", engagementStrategy: "Weekly content calendar reviews; Slack + email collaboration.", lastContact: "This week", ix: 8.5, iy: 4.5 },
  // Government
